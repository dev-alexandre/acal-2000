    ...
    public boolean numeroDisponivel (String numero) {
       ...
       List<Enderecopessoa> p = null;
        ...
        try{
           sessao = HibernateUtil.getSessionFactory().openSession();
           transacao = sessao.beginTransaction();
           query = sessao.createQuery("from Enderecopessoa p where p.numero = :numero ");
           query.setParameter("numero",numero);
           p  =  query.list();
           transacao.commit(); 
     ...
     public String donoDoNumero (String numero) {
        ...
        try{
           sessao = HibernateUtil.getSessionFactory().openSession();
           transacao = sessao.beginTransaction();
           query = sessao.createQuery("from Enderecopessoa ep inner join ep.idPessoa where ep.numero = :numero  ");
           query.setParameter("numero",numero);
           p  = (Enderecopessoa) query.uniqueResult();
           transacao.commit(); 
